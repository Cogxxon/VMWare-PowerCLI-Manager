...
Auther:
Version: 1.1b
Description: Short for write segmented line is a wrapper for the cmdlet write-host
             Makes it eaiser
Dependancies: None
...
function WRITE-SEGLINE{
    # Set Parems
    param(
           [int][parameter(Mandatory=$true)][Alias('nl')]
           $numlines,
          #---------
           [string[]][parameter(Mandatory=$false)][Alias('c')]
           $color,
          #---------
           [string[]][parameter(Mandatory=$true)][Alias('fl')]
           $firstline,
          #---------
           [string[]][parameter(Mandatory=$false)][Alias('sl')]
           $secondline,
          #---------
           [string[]][parameter(Mandatory=$false)][Alias('tl')]
           $thirdline,
          #---------
           [string[]][parameter(Mandatory=$false)][Alias('fhl')]
           $fourthline,
          #---------
           [string[]][parameter(Mandatory=$false)][Alias('ffhl')]
           $fifthline,
          #---------
           [switch][parameter(Mandatory=$false)][Alias('a')]
           $Action,
          #---------
           [switch][parameter(Mandatory=$false)][Alias('r')]
           $response,
          #---------
           [switch][parameter(Mandatory=$false)][Alias('e')]
           $error,
          #---------
           [switch][parameter(Mandatory=$false)][Alias('n')]
           $Notification,
          #---------
           [switch][parameter(Mandatory=$false)][Alias('ri')]
           $requestinput,
           [switch][parameter(Mandatory=$false)][Alias('nnl')]
           $nonewline
           )
