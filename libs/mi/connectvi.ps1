<#
    AUTHER======: Garvey Snow
    VERSION=====: 1.1b VMWARECLI Version
    DESCRIPTION=: Connect to a vCenter Server and return a connection instance 
                  giving access to the VMWARE.POWERCLI CMDLETS
    DEPENDANCIES: write-segling.ps1 -> Provided in folder
	BUILD ENV===: Powershell Version 5.0.10586.117
    LICENCE=====: GNU GENERAL PUBLIC LICENSE
    KB: o-> 
	UPDATED=====: 16/11/2017 @ 04:31PM
#>
