function storageReport()
{
    ...
    # build and object and plush into HASH Object Array for output/export
    ...
    {
            $dsMeta = Get-Datastore
          
            # QUERY STRING
            $dc_fpath = 'vmstores:\' + $Global:config.vcenter_Servers[0] + '@443\' + $global:config.data_center + '\' + $datastore
